# Sources:
# - Functions and utilities used in this script were sourced from the GitHub file:
#   https://github.com/brandonstarxel/chunking_evaluation/blob/main/chunking_evaluation/evaluation_framework/base_evaluation.py
# - Citation: 
