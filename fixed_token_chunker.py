# Sources:
# - Functions and utilities used in this script were sourced from the GitHub repository:
#   https://github.com/brandonstarxel/chunking_evaluation/tree/main/chunking_evaluation/chunking
# - Citation: 
...
# The original code can be found at: https://github.com/langchain-ai/langchain/blob/master/libs/text-splitters/langchain_text_splitters/base.py
# License: MIT License
